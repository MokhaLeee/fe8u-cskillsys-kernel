...
static const struct UnitDefinition CH1_MOULDER_TANA[] = {
    UNIT_ENTRY(CHARACTER_MOULDER, CLASS_PRIEST, FACTION_ID_BLUE, false, 1, 0, 0, 1, REDAs_NONE, 0, 0, 0, 0, ITEM_STAFF_HEAL, ITEM_VULNERARY),
    UNIT_ENTRY(CHARACTER_TANA, CLASS_PEGASUS_KNIGHT, FACTION_ID_BLUE, false, 1, 0, 0, 1, REDAs_NONE, 0, 0, 0, 0, ITEM_LANCE_SLIM, ITEM_LANCE_JAVELIN, ITEM_VULNERARY),
    {},
};
