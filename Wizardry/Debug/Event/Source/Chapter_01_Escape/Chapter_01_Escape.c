...
static const EventScr EventScr_Beginning[] = {
    ...
    //NOTIFY(MSG_ThousandGoldSpent, 2)

    // Currently the FADU is there for testing purposes
    FADU(16)
    SVAL(EVT_SLOT_3, (SID_Fury << 8) | CONFIG_ITEM_INDEX_SKILL_SCROLL)
    GIVEITEMTO(CHARACTER_EIRIKA)
    TUTORIALTEXT(Chapter_04_Tutorial_01)
