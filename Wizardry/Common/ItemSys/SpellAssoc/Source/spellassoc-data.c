...
const struct SpellAssoc gSpellAssocData_Rework[] = {
    ...
    SPELL_ASSOC_DATA_WPN_MAGIC(ITEM_MONSTER_DEMONSURGE, 0x45, SPELL_ASSOC_MCOLOR_NORMAL),
    ...
    SPELL_ASSOC_DATA_WPN_MAGIC(ITEM_MONSTER_SHADOWSHOT, 0x44, SPELL_ASSOC_MCOLOR_DARK),
