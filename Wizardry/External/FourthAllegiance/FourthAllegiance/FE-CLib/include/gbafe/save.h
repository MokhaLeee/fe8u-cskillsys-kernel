...
void LoadGeneralGameMetadata(struct GlobalSaveInfo* buf);
void SaveGeneralGameMetadata(struct GlobalSaveInfo* buf);

void SGM_SetCharacterKnown(unsigned charId, struct GlobalSaveInfo* sgm);
