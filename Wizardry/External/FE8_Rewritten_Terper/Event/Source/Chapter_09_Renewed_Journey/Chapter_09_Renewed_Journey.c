...
static const struct UnitDefinition CH9_NATASHA_RUNNING[] = {
...
static const struct UnitDefinition CH9_EIRIKA_SETH[] = {
...
static const struct UnitDefinition CH9_JOSHUA[] = {
...
static const struct UnitDefinition CH9_NATASHA[] = {
...
static const struct UnitDefinition CH9_SAAR_GLEN_CORMAG[] = {
...
static const struct UnitDefinition CH9_JOSHUA_ARENA[] = {
...
static const struct UnitDefinition CH9_GRADO_UNITS_PURSUING[] = {
...
static const struct UnitDefinition CH9_GRADO_ENEMY_UNITS[] = {
...
static const struct UnitDefinition CH9_TURN_2_REINFORCEMENTS[] = {
    ...
    UNIT_ENTRY(CHARACTER_ENEMY_65, CLASS_BRIGAND, FACTION_ID_RED, NO_ITEM_DROP, AUTOLEVEL, 4, 14, 15, 0, REDAs_NULL, 0, 4, 9, 0, ITEM_AXE_IRON), 
    {}
};

static const struct UnitDefinition CH9_TURN_6_REINFORCEMENTS[] = {
...
static const struct UnitDefinition CH9_TURN_8_REINFORCEMENTS[] = {
...
// LABEL(0x0)
    ...
    MUSC(BGM_SHOPS)
    LOAD_WAIT(CH9_JOSHUA)
    TEXT_BG(0x5, Chapter_05_Scene_01_Convo_01)
    LOAD_WAIT(CH9_NATASHA)
    ...
    LOAD_WAIT_PERSIST(CH9_SAAR_GLEN_CORMAG)
    FADE_IN_SCREEN(16)
    ...
    FADE_OUT_SCREEN(16)
    MUSC(0x7FFF)
    LOAD_WAIT_PERSIST(CH9_NATASHA_RUNNING)
    LOAD_WAIT_PERSIST(CH9_GRADO_UNITS_PURSUING)
    MUSC(BGM_RAID)
    TEXT(Chapter_05_Scene_04_Convo_01)
    LOAD_WAIT(CH9_JOSHUA_ARENA)
    ...
    LOAD_WAIT_PERSIST(CH9_GRADO_ENEMY_UNITS)
    MOVE_CAMERA_TO_POSITION(7, 14)
    LOAD_WAIT(CH9_EIRIKA_SETH)
...
static const EventListScr EventScr_CH9_TURN_6_REINFORCEMENTS[] = {
    CHECK_TURNS //Store current turn count in slot C
    SVAL(EVT_SLOT_7, 6)
    BNE(0x0, EVT_SLOT_C, EVT_SLOT_7)
    MOVE_CAMERA_TO_POSITION(14, 8)
    LOAD_WAIT_PERSIST(CH9_TURN_6_REINFORCEMENTS)
    GOTO(0x1)
...
static const EventListScr EventScr_CH9_TURN_8_REINFORCEMENTS[] = {
    CHECK_TURNS //Store current turn count in slot C
    SVAL(EVT_SLOT_7, 8)
    BNE(0x0, EVT_SLOT_C, EVT_SLOT_7)
    MOVE_CAMERA_TO_POSITION(13, 0)
    LOAD_WAIT_PERSIST(CH9_TURN_8_REINFORCEMENTS)
    GOTO(0x1)
...
static const EventListScr EventListScr_Turn[] = {
    AFEV(EVFLAG_TMP(7), EventScr_CH9_TURN_2_REINFORCEMENTS, 0)
    AFEV(EVFLAG_TMP(8), EventScr_CH9_TURN_6_REINFORCEMENTS, 0)
    AFEV(EVFLAG_TMP(9), EventScr_CH9_TURN_8_REINFORCEMENTS, 0)
    END_MAIN
};
...
static const EventListScr EventListScr_Location[] = {
    ARMORY(EventListScr_CH9_ARMORY, 2, 1)
    VENDOR(EventListScr_CH9_VENDOR, 6, 10)
