/* Jester - Commenting all of this out for now otherwise
** the lyn jump check won't shut up about these hooked functions
** not having a PUSH/POP sequence in a lyn jump file
*/
