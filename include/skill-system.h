...
u8 RallyDefense_Usability(const struct MenuItemDef * def, int number);
u8 RallyDefense_OnSelected(struct MenuProc * menu, struct MenuItemProc * item);
u8 RallyLuck_Usability(const struct MenuItemDef * def, int number);
u8 RallyLuck_OnSelected(struct MenuProc * menu, struct MenuItemProc * item);
u8 RallyMagic_Usability(const struct MenuItemDef * def, int number);
u8 RallyMagic_OnSelected(struct MenuProc * menu, struct MenuItemProc * item);
u8 RallyMovement_Usability(const struct MenuItemDef * def, int number);
u8 RallyMovement_OnSelected(struct MenuProc * menu, struct MenuItemProc * item);
u8 RallyResistance_Usability(const struct MenuItemDef * def, int number);
u8 RallyResistance_OnSelected(struct MenuProc * menu, struct MenuItemProc * item);
u8 RallySkill_Usability(const struct MenuItemDef * def, int number);
u8 RallySkill_OnSelected(struct MenuProc * menu, struct MenuItemProc * item);
...
u8 RallyStrength_Usability(const struct MenuItemDef * def, int number);
u8 RallyStrength_OnSelected(struct MenuProc * menu, struct MenuItemProc * item);
u8 RallySpectrum_Usability(const struct MenuItemDef * def, int number);
u8 RallySpectrum_OnSelected(struct MenuProc * menu, struct MenuItemProc * item);

/* Skill actions */
bool Action_HealingFocus(ProcPtr proc);
bool Action_Teleportation(ProcPtr parent);
bool Action_LightRune(ProcPtr parent);
bool Action_RallyDefense(ProcPtr proc);
bool Action_RallyLuck(ProcPtr proc);
bool Action_RallyMagic(ProcPtr proc);
bool Action_RallyMovement(ProcPtr proc);
bool Action_RallyResistance(ProcPtr proc);
bool Action_RallySkill(ProcPtr proc);
bool Action_RallySpeed(ProcPtr proc);
bool Action_RallyStrength(ProcPtr proc);
bool Action_RallySpectrum(ProcPtr proc);